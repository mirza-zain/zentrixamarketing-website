    ...
    <>
      <div className="w-full h-full flex flex-col xl:flex-row justify-center items-center">
        <div className="w-full xl:w-1/2 flex flex-col items-left justify-center gap-6 mx-5 p-5">
          ...
          <h2 className="xl:w-4/5 text-6xl lg:text-7xl font-bold">Bringing your creative <br /> <span className="text-indigo-600">visions to reality</span></h2> 
          <p className="w-full md:w-4/5 xl:w-11/12 text-lg text-gray-500 text-justify">From professional Wikipedia page creation to stunning FanArts, Comic Books, and Animations. We provide a complete suite of creative and writing services to elevate your brand globally.</p>
